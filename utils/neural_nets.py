...
class CryptoSoothsayer_PC_0(nn.Module):
	def __init__(self, input_size, n_signals):
		...
		self.layer_6 = nn.Linear(500, 200)
...
class CryptoSoothsayer_Laptop_1(nn.Module):
	def __init__(self, input_size, n_signals):
		...
		self.layer_4 = nn.Linear(256, 1024)
		self.layer_5 = nn.Linear(1024, 512)
		self.layer_6 = nn.Linear(512, 256)
		self.layer_7 = nn.Linear(256, 1024)
		self.layer_8 = nn.Linear(1024, 512)
		self.layer_9 = nn.Linear(512, 256)
		self.layer_10 = nn.Linear(256, 128)
		self.layer_11 = nn.Linear(128, 64)
		self.layer_12 = nn.Linear(64, 32)
