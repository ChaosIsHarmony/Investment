...
coins = ["bitcoin", "cardano", "ethereum", "matic-network", "solana", "terra-luna"]
possible_coins = ["algorand", "avalanche-2", "chainlink", "elrond-erd-2", "enjincoin", "polkadot", "theta-token", "zilliqa"]
