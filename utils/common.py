...
coins = ["bitcoin", "cardano", "chainlink", "ethereum", "matic-network","polkadot", "solana", "terra-luna"]
possible_coins = ["algorand", "avalanche-2", "elrond-erd-2", "enjincoin", "theta-token", "zilliqa"]
