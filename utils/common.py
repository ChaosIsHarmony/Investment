...
coins = ["bitcoin", "cardano", "chainlink", "enjincoin", "ethereum", "matic-network","polkadot", "solana", "terra-luna"]
possible_coins = ["algorand", "avalanche-2", "elrond-erd-2", "theta-token", "zilliqa"]
